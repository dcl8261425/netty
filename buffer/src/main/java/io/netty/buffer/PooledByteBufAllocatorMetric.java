...
public final class PooledByteBufAllocatorMetric implements ByteBufAllocatorMetric {
    ...
    public String toString() {
        ...
        sb.append(StringUtil.simpleClassName(this)).append('(')
                .append("usedHeapMemory: ").append(usedHeapMemory()).append("; ")
                .append("usedDirectMemory: ").append(usedDirectMemory()).append("; ")
                .append("numHeapArenas: ").append(numHeapArenas()).append("; ")
                .append("numDirectArenas: ").append(numDirectArenas()).append("; ")
                .append("tinyCacheSize: ").append(tinyCacheSize()).append("; ")
                .append("smallCacheSize: ").append(smallCacheSize()).append("; ")
                .append("normalCacheSize: ").append(normalCacheSize()).append("; ")
                .append("numThreadLocalCaches: ").append(numThreadLocalCaches()).append("; ")
